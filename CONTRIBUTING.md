...
When contributing to "Pop-up windows" you have to follow some conventions and a simple workflow. It allows me to handle the requests quickly and ensure best quality
for the "Pop-up windows" core code.
...
The preferred way to report bugs is to use the [GitHub issue tracker](https://github.com/ArthurGareginyan/pop-up-windows/issues). Before reporting a bug, read these pointers.
...
- "Pop-up windows" is maintained by me. I don't owe you anything, so be polite. Reports with an indignant or belligerent tone tend to be moved to the bottom of the pile.
...
- Mention which release of "Pop-up windows" you're using.
...
- Fork [Pop-up windows](https://github.com/ArthurGareginyan/pop-up-windows)
...
By contributing code to "Pop-up windows" you:
